...
'''
#
def spec_augment(mel_spectrogram, time_warping_para=80, frequency_masking_para=15,
    ...
    for i in range(frequency_mask_num):
        f = np.random.uniform(low=0.0, high=frequency_masking_para) # 0~15
        f = int(f)
